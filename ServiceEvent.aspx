...
<body>
    <form id="form1" runat="server">
        <div style="margin-left: 0px">
            ...
            <asp:Button ID="btnClear" runat="server" Font-Bold="True" style="z-index: 1; left: 215px; top: 384px; position: absolute; width: 125px" Text="Clear" OnClick="btnClear_Click" />
