...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txtEMail" runat="server" style="z-index: 1; left: 171px; top: 345px; position: absolute; width: 274px" TabIndex="5"></asp:TextBox>
            <asp:TextBox ID="txtDept" runat="server" style="z-index: 1; left: 172px; top: 389px; position: absolute; width: 110px; margin-top: 0px" TabIndex="6"></asp:TextBox>
            <asp:TextBox ID="txtRate" runat="server" style="z-index: 1; left: 172px; top: 465px; position: absolute; width: 106px" TabIndex="8"></asp:TextBox>
            <asp:Button ID="btnNewTech" runat="server" Font-Bold="True" OnClick="btnNewTech_Click" style="z-index: 1; left: 397px; top: 176px; position: absolute; height: 39px; width: 204px" TabIndex="13" Text="New Technician" />
        </div>
        <asp:DropDownList ID="drpTech" runat="server" AutoPostBack="true" Font-Names="Arial" Font-Size="Medium" OnSelectedIndexChanged="drpProdID_SelectedIndexChanged" style="z-index: 1; left: 170px; top: 181px; position: absolute; width: 189px;">
        </asp:DropDownList>
    </form>
</body>
</html>
