...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnClear" runat="server" style="z-index: 1; left: 425px; top: 567px; position: absolute; height: 50px; width: 111px" Text="Clear" Enabled="False" Font-Bold="True" OnClick="btnClear_Click" />
            <asp:Button ID="btnCancel" runat="server" Enabled="False" style="z-index: 1; left: 162px; top: 567px; position: absolute; absolute; height: 50px;width: 110px" Text="Cancel" Font-Bold="True" OnClick="btnCancel_Click" />
            <asp:Button ID="btnAccept" runat="server" Enabled="False" style="z-index: 1; left: 34px; top: 568px; position: absolute; absolute; height: 50px;width: 110px" Text="Accept" Font-Bold="True" />
            ...
            <asp:Button ID="btnRemove" runat="server" Enabled="False" style="z-index: 1; left: 291px; top: 567px; position: absolute; width: 110px; right: 653px; height: 50px; margin-top: 0px" Text="Remove" Font-Bold="True" />
            ...
            <asp:Button ID="btnNewTech" runat="server" Font-Bold="True" OnClick="btnNewTech_Click" style="z-index: 1; left: 397px; top: 176px; position: absolute; height: 39px; width: 204px" Text="New Technician" />
        </div>
        <asp:DropDownList ID="drpTech" runat="server" AutoPostBack="true" Font-Names="Arial" Font-Size="Medium" OnSelectedIndexChanged="drpProdID_SelectedIndexChanged" style="z-index: 1; left: 170px; top: 181px; position: absolute; width: 189px;" TabIndex="3">
        </asp:DropDownList>
    </form>
</body>
</html>
