...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:Button ID="btnProblem" runat="server" Enabled="False" style="z-index: 1; left: 181px; top: 263px; position: absolute; width: 128px; margin-bottom: 0px; height: 45px; bottom: 340px;" Text="Problem" Font-Bold="True" />
