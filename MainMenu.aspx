...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:Button ID="btnProblem" runat="server" style="z-index: 1; left: 181px; top: 263px; position: absolute; width: 128px; margin-bottom: 0px; height: 45px; bottom: 340px;" Text="Resolution" Font-Bold="True" OnClick="btnProblem_Click" />
            <asp:Button ID="btnReport" runat="server" style="z-index: 1; left: 179px; top: 321px; position: absolute; width: 131px; height: 45px;" Text="Report" Enabled="False" Font-Bold="True" />
        </div>
