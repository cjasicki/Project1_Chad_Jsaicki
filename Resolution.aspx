...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 83px; top: 713px; position: absolute" Text="Error"></asp:Label>
...
&nbsp;<asp:Label ID="lblHr" runat="server" style="z-index: 1; left: 85px; top: 482px; position: absolute" Text="* Hours:"></asp:Label>
            ...
            <asp:Label ID="lblReq" runat="server" ForeColor="Red" style="z-index: 1; left: 78px; top: 664px; position: absolute; height: 21px" Text="* Indicates required fields"></asp:Label>
            <asp:TextBox ID="txtMiles" runat="server" style="z-index: 1; left: 390px; top: 481px; position: absolute; width: 50px; height: 18px; "></asp:TextBox>
            <asp:TextBox ID="txtMisc" runat="server" style="z-index: 1; left: 388px; top: 522px; position: absolute; width: 50px; height: 18px"></asp:TextBox>
            <asp:TextBox ID="txtDateOnsite" runat="server" style="z-index: 1; left: 174px; top: 601px; position: absolute; width: 170px; height: 18px" TextMode="DateTimeLocal"></asp:TextBox>
            <asp:TextBox ID="txtSupplies" runat="server" style="z-index: 1; left: 174px; top: 518px; position: absolute; width: 50px; height: 24px"></asp:TextBox>
            <asp:TextBox ID="txtDateRep" runat="server" style="z-index: 1; left: 173px; top: 562px; position: absolute; width: 174px; height: 18px" TextMode="DateTimeLocal"></asp:TextBox>
            <asp:TextBox ID="txtCostMiles" runat="server" style="z-index: 1; left: 595px; top: 477px; position: absolute; width: 50px; height: 18px"></asp:TextBox>
            ...
            <asp:Button ID="btnClear" runat="server" OnClick="btnClear_Click" style="z-index: 1; left: 323px; top: 744px; position: absolute; width: 111px; height: 30px" Text="Clear" />
            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" style="z-index: 1; left: 173px; top: 745px; position: absolute; width: 112px; height: 31px" Text="Submint" AccessKey="s" />
&nbsp;<asp:DropDownList ID="drpTech" runat="server" style="z-index: 1; left: 172px; top: 429px; position: absolute; width: 149px">
            </asp:DropDownList>
            <asp:TextBox ID="txtHours" runat="server" AccessKey="h" style="z-index: 1; left: 173px; top: 478px; position: absolute; width: 56px; height: 24px"></asp:TextBox>
        ...
        <asp:CheckBox ID="ckb_NoCharge" runat="server" style="z-index: 1; left: 391px; top: 210px; position: absolute; height: 32px; width: 159px" />
