...
namespace Project1_Chad_Jsaicki
{
    public partial class ProblemEntry : System.Web.UI.Page
    {
        ...
        protected void IncreamentCounter(object sender, EventArgs e)  //Increament problem number on the form
        {
            int counter;
        ...
        private void LoadsPoductdrp()  //add items to the product dropdown list
        {
            DataSet dsData;
        ...
        private void LoadsTechdrp()   //add items to the tech's dropdown list
        {
            DataSet dsData;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!blErrState)
            {
                ...
                {
                    int counter;
                    if (ViewState["Count"] != null) //updates the problem number on the webform if counter is 
                    {
                        counter = Convert.ToInt32(ViewState["Count"]);
                    }
                    else
